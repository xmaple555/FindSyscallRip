...
# Demo
## UsingWinSyscall
Before doing anything, we need to know what address UsingWinSyscall calls NtQuerySystemInformation at. Because UsingWinSyscall uses VirtualAlloc to allocate the syscall memory, we need to find the adress via dynamic analysis.
